export const personalInfo = {
  ...
  status: "Disponible para Oportunidades de Desarrollo",
  stats: [
    { label: "Pasión por la Tech", value: "100%" },
    { label: "Ambición & Crecimiento", value: "Full" },
    { label: "Tecnologías & Tools", value: "18+" },
...
export const techCategories = [
  ...
  { id: "frontend", name: "Frontend, CSS & UI" },
...
export const skills = [
  // Backend & Frameworks
  { name: "PHP 8.3+ & Laravel 13", category: "backend", icon: "Server", color: "#10b981", desc: "Arquitectura MVC, Eloquent ORM, Sanctum Auth, Queues, Middlewares y Livewire 4." },
  { name: "Python 3 & Scripting", category: "backend", icon: "Terminal", color: "#38bdf8", desc: "Agentes autónomos de telemetría (psutil), llamadas a kernel, FastAPI y scripts de automatización." },
  { name: "Java (POO & Core)", category: "backend", icon: "Code2", color: "#f59e0b", desc: "Programación Orientada a Objetos, estructuras de datos, algoritmos y diseño modular." },
  { name: "WebSockets (Laravel Reverb)", category: "backend", icon: "Zap", color: "#34d399", desc: "Canales de comunicación bidireccional en tiempo real sin sobrecarga de memoria." },

  // Frontend, CSS & UI
  { name: "Laravel Livewire 4", category: "frontend", icon: "Workflow", color: "#6366f1", desc: "Reactividad completa en el servidor sin sobrecarga de JS pesado en cliente." },
  { name: "JavaScript (ES6+)", category: "frontend", icon: "FileCode2", color: "#f59e0b", desc: "Manipulación DOM, peticiones asíncronas AJAX/Fetch, eventos y lógica cliente." },
  { name: "Sass / SCSS & BEM Architecture", category: "frontend", icon: "Palette", color: "#ec4899", desc: "Preprocesamiento CSS modular, metrología de clases BEM, mixins y arquitecturas de diseño limpias." },
  { name: "CSS Variables & Design Tokens", category: "frontend", icon: "Layout", color: "#10b981", desc: "Sistemas de diseño dinámicos, animaciones aceleradas por hardware y Container Queries." },
  { name: "HTML5 & CSS3 Responsive", category: "frontend", icon: "Layout", color: "#3b82f6", desc: "Maquetación semántica, diseño accesible Mobile First, Flexbox y CSS Grid." },
  { name: "Tailwind CSS v4 & Mary UI", category: "frontend", icon: "Palette", color: "#38bdf8", desc: "Compilación nativa ultra-rápida, dashboards en modo oscuro y componentes reactivos." },

  // Bases de Datos
  { name: "SQLite 3 (Embebido)", category: "database", icon: "DatabaseZap", color: "#6366f1", desc: "Optimización con 0% RAM en reposo, unificación de sesiones y colas (Queue Driver)." },
  { name: "MySQL & SQL Relacional", category: "database", icon: "Database", color: "#10b981", desc: "Diseño de esquemas E-R, indexación, consultas avanzadas con Joins y transacciones." },

  // Sistemas, DevOps & Cripto
  { name: "Docker & Docker Compose", category: "systems", icon: "Box", color: "#38bdf8", desc: "Contenerización de microservicios y apps, volúmenes de datos y redes aisladas en ZimaBlade/Linux." },
  { name: "Administración Linux & Systemd", category: "systems", icon: "Cpu", color: "#f59e0b", desc: "Gestión de demonios systemd, monitorización de hardware, supervisión de procesos y bash scripting." },
  { name: "SSH Remoto & Criptografía / 2FA", category: "systems", icon: "ShieldCheck", color: "#10b981", desc: "Túneles SSH en vivo con phpseclib 3, autenticación multifactor TOTP con Google2FA y cifrado." },
  { name: "Git & GitHub Actions", category: "systems", icon: "GitBranch", color: "#6366f1", desc: "Control de versiones, Conventional Commits, integración continua (CI/CD) y ramas." }
];
...
export const projectCategories = [
  ...
  { id: "recommended", name: "Plataformas & Arquitecturas" }
];
...
export const projects = [
  ...
  // 6 Recommended High-Impact Projects for Companies
  {
    ...
    categoryLabel: "Arquitectura & Plataforma",
  ...
  },
  {
    ...
    category: "recommended",
    categoryLabel: "Arquitectura & Backend",
  ...
  },
  {
    ...
    category: "recommended",
    categoryLabel: "Arquitectura Enterprise",
  ...
  },
  {
    ...
    category: "recommended",
    categoryLabel: "Arquitectura E-Commerce",
  ...
  },
  {
    ...
    category: "recommended",
    categoryLabel: "Arquitectura WebSockets",
    badge: "Servicio WebSockets",
    icon: "PhoneCall",
    color: "#14b8a6",
  ...
  },
  {
    ...
    category: "recommended",
    categoryLabel: "Arquitectura Cloud",
    badge: "Solución Cloud",
    icon: "Activity",
    color: "#8b5cf6",
    tags: ["PHP / Laravel", "AWS S3 / MinIO", "Docker", "JavaScript", "SQLite/MySQL"],
    metrics: ["Subida en Chunks", "Enlaces Temporales Cifrados", "Integración S3"],
    highlights: [
